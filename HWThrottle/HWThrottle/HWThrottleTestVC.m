...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.selectedMode = HWThrottleModeFirstly;
...
- (void)selectMode {
    ...
    [alertVC addAction:[UIAlertAction actionWithTitle:[self nameForMode:HWThrottleModeFirstly]
                                                style:UIAlertActionStyleDefault
                                              handler:block]];
    [alertVC addAction:[UIAlertAction actionWithTitle:[self nameForMode:HWThrottleModeLast]
                                                style:UIAlertActionStyleDefault
                                              handler:block]];
    [alertVC addAction:[UIAlertAction actionWithTitle:[self nameForMode:HWThrottleModeDebounce]
                                                style:UIAlertActionStyleDefault
                                              handler:block]];
...
- (UIButton *)testButton {
    if (!_testButton) {
        ...
        _testButton.backgroundColor = [self colorForR:65 G:162 B:192];
        ...
        [_testButton setTitleColor:[self colorForR:65 G:162 B:192] forState:UIControlStateHighlighted];
